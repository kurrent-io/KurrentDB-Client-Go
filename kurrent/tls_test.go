...
func testTLSDefaults(container *Container) TestCall {
	return func(t *testing.T) {
		config, err := kurrent.ParseConnectionString(fmt.Sprintf("esdb://admin:changeit@%s", container.Endpoint))
		if err != nil {
			t.Fatalf("Unexpected configuration error: %s", err.Error())
		}

		c, err := kurrent.NewClient(config)
		if err != nil {
...
func testTLSWithoutCertificateAndVerify(container *Container) TestCall {
	return func(t *testing.T) {
		config, err := kurrent.ParseConnectionString(fmt.Sprintf("esdb://admin:changeit@%s?tls=true&tlsverifycert=false", container.Endpoint))
		if err != nil {
			t.Fatalf("Unexpected configuration error: %s", err.Error())
		}
...
func testTLSWithoutCertificate(container *Container) TestCall {
	return func(t *testing.T) {
		config, err := kurrent.ParseConnectionString(fmt.Sprintf("esdb://admin:changeit@%s?tls=true&tlsverifycert=true", container.Endpoint))
		if err != nil {
			t.Fatalf("Unexpected configuration error: %s", err.Error())
		}
...
func testTLSWithCertificateFromAbsoluteFile(container *Container) TestCall {
	return func(t *testing.T) {
		...
		config, err := kurrent.ParseConnectionString(s)
		if err != nil {
			t.Fatalf("Unexpected configuration error: %s", err.Error())
		}
...
func testTLSWithCertificateFromRelativeFile(container *Container) TestCall {
	return func(t *testing.T) {
		config, err := kurrent.ParseConnectionString(fmt.Sprintf("esdb://admin:changeit@%s?tls=true&tlsverifycert=true&tlsCAFile=../certs/node/node.crt", container.Endpoint))
		if err != nil {
			t.Fatalf("Unexpected configuration error: %s", err.Error())
		}
