...
func (*ReadResp_StreamNotFound) Descriptor() ([]byte, []int) {
	return file_streams_proto_rawDescGZIP(), []int{1, 6}
}
...
func (x *TombstoneResp_Position) Reset() {
	*x = TombstoneResp_Position{}
	mi := &file_streams_proto_msgTypes[41]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_streams_proto_rawDesc = "" +
	"\n" +
	"\rstreams.proto\x12\x1aevent_store.client.streams\x1a\fshared.proto\x1a\fstatus.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfb\x10\n" +
	"\aReadReq\x12E\n" +
	...
	"\vBatchAppend\x12*.event_store.client.streams.BatchAppendReq\x1a+.event_store.client.streams.BatchAppendResp(\x010\x01Ba\n" +
	"%com.eventstore.dbclient.proto.streamsZ8github.com/kurrent-io/KurrentDB-Client-Go/protos/streamsb\x06proto3"
...
var file_streams_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
...
func file_streams_proto_init() {
	...
	file_streams_proto_msgTypes[19].OneofWrappers = []any{}
	file_streams_proto_msgTypes[20].OneofWrappers = []any{}
	file_streams_proto_msgTypes[21].OneofWrappers = []any{
		(*ReadResp_ReadEvent_CommitPosition)(nil),
		(*ReadResp_ReadEvent_NoPosition)(nil),
	}
	file_streams_proto_msgTypes[28].OneofWrappers = []any{
	...
	file_streams_proto_msgTypes[34].OneofWrappers = []any{
