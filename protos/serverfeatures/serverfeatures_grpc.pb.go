...
const (
	ServerFeatures_GetSupportedMethods_FullMethodName = "/event_store.client.server_features.ServerFeatures/GetSupportedMethods"
)
...
func (c *serverFeaturesClient) GetSupportedMethods(ctx context.Context, in *shared.Empty, opts ...grpc.CallOption) (*SupportedMethods, error) {
	...
	err := c.cc.Invoke(ctx, ServerFeatures_GetSupportedMethods_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedServerFeaturesServer must be embedded to have
...
func (UnimplementedServerFeaturesServer) testEmbeddedByValue()                        {}
...
func RegisterServerFeaturesServer(s grpc.ServiceRegistrar, srv ServerFeaturesServer) {
	// If the following call pancis, it indicates UnimplementedServerFeaturesServer was
...
func _ServerFeatures_GetSupportedMethods_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServerFeatures_GetSupportedMethods_FullMethodName,
	}
