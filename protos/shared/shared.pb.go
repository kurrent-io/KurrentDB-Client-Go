...
const file_shared_proto_rawDesc = "" +
	"\n" +
	"\fshared.proto\x12\x12event_store.client\x1a\x1bgoogle/protobuf/empty.proto\"\xe8\x01\n" +
	"\x04UUID\x12E\n" +
	"\n" +
	...
	"$com.eventstore.dbclient.proto.sharedZ7github.com/kurrent-io/KurrentDB-Client-Go/protos/sharedb\x06proto3"
...
func file_shared_proto_init() {
	...
	file_shared_proto_msgTypes[4].OneofWrappers = []any{
